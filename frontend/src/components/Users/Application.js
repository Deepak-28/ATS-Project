...
function Application() {
    ...
    const handleResume = async () => {
        ...
        try {
            ...
            const name = selectedFile.name.slice(0, selectedFile.name.lastIndexOf('.'));
            ...
            <div className='application_content'>
                ...
                <div className='input_box'>
                    ...
                    >
                        ...
                        {Experience.map((item, index) => (
                            <option value={item} key={index}>{item} year</option>
                        ))}
                    </select>
                </div>
                <div className="input_box">
                ...
                <div className='input_box resume'>
                    ...
                    <div className='resume_box'>
                        <label htmlFor='resume' className='resume_upload'> < FaCloudUploadAlt /></label>
                        <input
                            type="file"
                            id="resume"
                            accept='.pdf'
